...
Public Class WashbacksAcquiredEventInformationDlg
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colTagWashbacksAcquiredEventTagIDDataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
    Friend WithEvents colTagWashbacksAcquiredEventIDDataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(WashbacksAcquiredEventInformationDlg))
        ...
        '
        'WashbacksAcquiredEventInformationDlg
        '
        ...
        Me.Name = "WashbacksAcquiredEventInformationDlg"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Washbacks Acquired Event"
...
#End Region
    ...
    Private moWashbacksAcquiredEvent As WashbacksAcquiredEvent

    Public Sub New(ByVal oWashbacksAcquiredEvent As WashbacksAcquiredEvent)
        ...
        moWashbacksAcquiredEvent = oWashbacksAcquiredEvent

    End Sub

    Private Sub frmWashbacksAcquiredEventInformationDlg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            '*** ASSERTION ***
            If moWashbacksAcquiredEvent Is Nothing Then
                Throw New ApplicationException("WashbacksAcquiredEvent object must be set before opening this screen.")
            End If
            '*** ASSERTION ***
            ...
            '----------------------------------------------------------------
            moWashbacksAcquiredEvent.BeginEdit()

            Me.cboSpeciesList.SelectedIndex = cboSpeciesList.FindString(moWashbacksAcquiredEvent.SpeciesCode)

            Me.dtpEventDate.DateValue = moWashbacksAcquiredEvent.EventDate

            If (moWashbacksAcquiredEvent.EventCount = 0) Then
                Me.txtEventCount.Text = String.Empty
            Else
                Me.txtEventCount.Text = Convert.ToString(moWashbacksAcquiredEvent.EventCount)
            End If

            Me.cboCountyList.SelectedIndex = cboCountyList.FindString(moWashbacksAcquiredEvent.AcquiredFromCounty)
            Me.chkUnder5cmClsl.Checked = moWashbacksAcquiredEvent.Under5CmClsl
    ...
    Private Sub frmWashbacksAcquiredEventInformationDlg_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Function DoCancelLogic() As Boolean
        ...
        Try
            ...
            '------------------------------------------------------------ 
            If moWashbacksAcquiredEvent.IsDirty Then
            ...
            '------------------------------------------------------------ 
            moWashbacksAcquiredEvent.CancelEdit()
    ...
    Private Function DoSaveLogic() As Boolean
        ...
        '------------------------------------------------------------ 
        Dim oTempWashbacksAcquiredEvent As WashbacksAcquiredEvent
        ...
        Try
            ...
            If moWashbacksAcquiredEvent.IsDirty Then
                ...
                '------------------------------------------------------------ 
                If moWashbacksAcquiredEvent.IsValid Then

                    '----------------------------------------------------------------
                    '-- commit edits in memory
                    '----------------------------------------------------------------
                    moWashbacksAcquiredEvent.ApplyEdit()

                    '----------------------------------------------------------------
                    '-- clone and save the object (it is the CSLA way)
                    '----------------------------------------------------------------
                    oTempWashbacksAcquiredEvent = moWashbacksAcquiredEvent.Clone
                    moWashbacksAcquiredEvent = oTempWashbacksAcquiredEvent.Save
    ...
    Private Sub DisplayBrokenRules(Optional ByVal bShowMessageBox As Boolean = False)
        ...
        Try
            ...
            If (bShowMessageBox) Then
                MessageBox.Show(" *** The following data validation issue(s) must be resolved before this package can be saved: *** " & ControlChars.CrLf & ControlChars.CrLf & moWashbacksAcquiredEvent.GetBrokenRulesString, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If

            For i = 0 To moWashbacksAcquiredEvent.BrokenRulesCollection.Count() - 1
                Select Case moWashbacksAcquiredEvent.BrokenRulesCollection(i).Property
                    Case "EventCount"
                        erpErrorProvider.SetError(Me.txtEventCount, moWashbacksAcquiredEvent.BrokenRulesCollection(i).Description)
                End Select
            Next
    ...
    Private Sub CopyFormValuesToBusinessObject()
        ...
        If cboSpeciesList.SelectedIndex > -1 Then
            moWashbacksAcquiredEvent.SpeciesCode = CType(Me.cboSpeciesList.SelectedItem, KeyValueInfo).Key
        End If

        moWashbacksAcquiredEvent.EventDate = Me.dtpEventDate.DateValue
        moWashbacksAcquiredEvent.EventCount = Convert.ToInt32(Val(Me.txtEventCount.Text.Trim))
        moWashbacksAcquiredEvent.AcquiredFromCounty = Me.cboCountyList.Text.Trim
        moWashbacksAcquiredEvent.Under5CmClsl = Me.chkUnder5cmClsl.Checked

    End Sub

    Private Sub btnHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        Help.ShowHelp(Me, gsHelpFileName, "WashbacksAcquiredEventScreen.htm")
    End Sub

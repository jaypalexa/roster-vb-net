...
Public Class MarineTurtleCaptiveFacilityQuarterlyReportForHatchlingsDlg
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MarineTurtleCaptiveFacilityQuarterlyReportForHatchlingsDlg))
        ...
        '
        'MarineTurtleCaptiveFacilityQuarterlyReportForHatchlingsDlg
        '
        ...
        Me.Name = "MarineTurtleCaptiveFacilityQuarterlyReportForHatchlingsDlg"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Marine Turtle Captive Facility Quarterly Report For Hatchlings"
...
#End Region
    ...
    Private Sub frmMarineTurtleCaptiveFacilityQuarterlyReportForHatchlingsDlg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        ...
        Dim sFieldsReportName As String = MASTER_MARINE_TURTLE_CAPTIVE_FACILITY_QUARTERLY_REPORT_FOR_HATCHLINGS_PDF
        ...
        Dim oCaptiveFacilityHatchlingsReportItem As CaptiveFacilityHatchlingsReportItem
        ...
        Try
            ...
            Else 'If radFillDatabase.Checked Then
                ...
                '----------------------------------------------------------------
                '-- get HATCHLING EVENT data for report
                '----------------------------------------------------------------
                oCaptiveFacilityHatchlingsReportItem = CaptiveFacilityHatchlingsReportItem.GetCaptiveFacilityHatchlingsReportItem(dtDateFrom, dtDateThru)
                ...
                iStartingBalance = oCaptiveFacilityHatchlingsReportItem.CcHatchlingStartingBalance + oCaptiveFacilityHatchlingsReportItem.CcHatchlingAdditionsBeforeThisPeriod - oCaptiveFacilityHatchlingsReportItem.CcHatchlingSubtractionsBeforeThisPeriod
                oAcroFields.SetField("txtCcPrevBal", Convert.ToString(iStartingBalance))
                oAcroFields.SetField("txtCcAcquired", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CcHatchlingsAcquiredThisPeriod))
                oAcroFields.SetField("txtCcDied", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CcHatchlingsDiedThisPeriod))
                oAcroFields.SetField("txtCcReleased", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CcHatchlingsReleasedOnTheBeachThisPeriod + oCaptiveFacilityHatchlingsReportItem.CcHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtCcEndBal", Convert.ToString(iStartingBalance + oCaptiveFacilityHatchlingsReportItem.CcHatchlingsAcquiredThisPeriod - oCaptiveFacilityHatchlingsReportItem.CcHatchlingsDiedThisPeriod - oCaptiveFacilityHatchlingsReportItem.CcHatchlingsReleasedOnTheBeachThisPeriod - oCaptiveFacilityHatchlingsReportItem.CcHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtCcBeachVsOffshore", "Beach: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CcHatchlingsReleasedOnTheBeachThisPeriod) & ControlChars.NewLine & "Offshore: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CcHatchlingsReleasedOffshoreThisPeriod))

                iStartingBalance = oCaptiveFacilityHatchlingsReportItem.CmHatchlingStartingBalance + oCaptiveFacilityHatchlingsReportItem.CmHatchlingAdditionsBeforeThisPeriod - oCaptiveFacilityHatchlingsReportItem.CmHatchlingSubtractionsBeforeThisPeriod
                oAcroFields.SetField("txtCmPrevBal", Convert.ToString(iStartingBalance))
                oAcroFields.SetField("txtCmAcquired", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CmHatchlingsAcquiredThisPeriod))
                oAcroFields.SetField("txtCmDied", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CmHatchlingsDiedThisPeriod))
                oAcroFields.SetField("txtCmReleased", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CmHatchlingsReleasedOnTheBeachThisPeriod + oCaptiveFacilityHatchlingsReportItem.CmHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtCmEndBal", Convert.ToString(iStartingBalance + oCaptiveFacilityHatchlingsReportItem.CmHatchlingsAcquiredThisPeriod - oCaptiveFacilityHatchlingsReportItem.CmHatchlingsDiedThisPeriod - oCaptiveFacilityHatchlingsReportItem.CmHatchlingsReleasedOnTheBeachThisPeriod - oCaptiveFacilityHatchlingsReportItem.CmHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtCmBeachVsOffshore", "Beach: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CmHatchlingsReleasedOnTheBeachThisPeriod) & ControlChars.NewLine & "Offshore: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CmHatchlingsReleasedOffshoreThisPeriod))

                iStartingBalance = oCaptiveFacilityHatchlingsReportItem.DcHatchlingStartingBalance + oCaptiveFacilityHatchlingsReportItem.DcHatchlingAdditionsBeforeThisPeriod - oCaptiveFacilityHatchlingsReportItem.DcHatchlingSubtractionsBeforeThisPeriod
                oAcroFields.SetField("txtDcPrevBal", Convert.ToString(iStartingBalance))
                oAcroFields.SetField("txtDcAcquired", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.DcHatchlingsAcquiredThisPeriod))
                oAcroFields.SetField("txtDcDied", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.DcHatchlingsDiedThisPeriod))
                oAcroFields.SetField("txtDcReleased", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.DcHatchlingsReleasedOnTheBeachThisPeriod + oCaptiveFacilityHatchlingsReportItem.DcHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtDcEndBal", Convert.ToString(iStartingBalance + oCaptiveFacilityHatchlingsReportItem.DcHatchlingsAcquiredThisPeriod - oCaptiveFacilityHatchlingsReportItem.DcHatchlingsDiedThisPeriod - oCaptiveFacilityHatchlingsReportItem.DcHatchlingsReleasedOnTheBeachThisPeriod - oCaptiveFacilityHatchlingsReportItem.DcHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtDcBeachVsOffshore", "Beach: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.DcHatchlingsReleasedOnTheBeachThisPeriod) & ControlChars.NewLine & "Offshore: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.DcHatchlingsReleasedOffshoreThisPeriod))

                iStartingBalance = oCaptiveFacilityHatchlingsReportItem.OtherHatchlingStartingBalance + oCaptiveFacilityHatchlingsReportItem.OtherHatchlingAdditionsBeforeThisPeriod - oCaptiveFacilityHatchlingsReportItem.OtherHatchlingSubtractionsBeforeThisPeriod
                oAcroFields.SetField("txtOtherPrevBal", Convert.ToString(iStartingBalance))
                oAcroFields.SetField("txtOtherAcquired", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsAcquiredThisPeriod))
                oAcroFields.SetField("txtOtherDied", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsDiedThisPeriod))
                oAcroFields.SetField("txtOtherReleased", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsReleasedOnTheBeachThisPeriod + oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtOtherEndBal", Convert.ToString(iStartingBalance + oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsAcquiredThisPeriod - oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsDiedThisPeriod - oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsReleasedOnTheBeachThisPeriod - oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtOtherBeachVsOffshore", "Beach: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsReleasedOnTheBeachThisPeriod) & ControlChars.NewLine & "Offshore: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsReleasedOffshoreThisPeriod))

                iStartingBalance = oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingStartingBalance + oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingAdditionsBeforeThisPeriod - oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingSubtractionsBeforeThisPeriod
                oAcroFields.SetField("txtUnknownPrevBal", Convert.ToString(iStartingBalance))
                oAcroFields.SetField("txtUnknownAcquired", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsAcquiredThisPeriod))
                oAcroFields.SetField("txtUnknownDied", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsDiedThisPeriod))
                oAcroFields.SetField("txtUnknownReleased", Convert.ToString(oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsReleasedOnTheBeachThisPeriod + oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtUnknownEndBal", Convert.ToString(iStartingBalance + oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsAcquiredThisPeriod - oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsDiedThisPeriod - oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsReleasedOnTheBeachThisPeriod - oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsReleasedOffshoreThisPeriod))
                oAcroFields.SetField("txtUnknownBeachVsOffshore", "Beach: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsReleasedOnTheBeachThisPeriod) & ControlChars.NewLine & "Offshore: " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsReleasedOffshoreThisPeriod))

                If (Me.chkIncludeDoaCounts.Checked) Then

                    If (oCaptiveFacilityHatchlingsReportItem.CcHatchlingsDoaThisPeriod > 0) Then
                        If (sComments.Length > 0) Then
                            sComments &= "; "
                        End If
                        sComments &= "DOA Cc hatchlings = " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CcHatchlingsDoaThisPeriod)
                    End If

                    If (oCaptiveFacilityHatchlingsReportItem.CmHatchlingsDoaThisPeriod > 0) Then
                        If (sComments.Length > 0) Then
                            sComments &= "; "
                        End If
                        sComments &= "DOA Cm hatchlings = " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.CmHatchlingsDoaThisPeriod)
                    End If

                    If (oCaptiveFacilityHatchlingsReportItem.DcHatchlingsDoaThisPeriod > 0) Then
                        If (sComments.Length > 0) Then
                            sComments &= "; "
                        End If
                        sComments &= "DOA Dc hatchlings = " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.DcHatchlingsDoaThisPeriod)
                    End If

                    If (oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsDoaThisPeriod > 0) Then
                        If (sComments.Length > 0) Then
                            sComments &= "; "
                        End If
                        sComments &= "DOA Other hatchlings = " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.OtherHatchlingsDoaThisPeriod)
                    End If

                    If (oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsDoaThisPeriod > 0) Then
                        If (sComments.Length > 0) Then
                            sComments &= "; "
                        End If
                        sComments &= "DOA Unknown hatchlings = " & Convert.ToString(oCaptiveFacilityHatchlingsReportItem.UnknownHatchlingsDoaThisPeriod)
                    End If
        ...
        Finally
            ...
            oCaptiveFacilityHatchlingsReportItem = Nothing
    ...
    Private Sub btnHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        Help.ShowHelp(Me, gsHelpFileName, "MarineTurtleCaptiveFacilityQuarterlyReportForHatchlings.htm")
    End Sub
...
#Region " Saved Reports Grid "
    ...
    Private Sub LoadSavedReportGridData()
        ...
        Try
            ...
            '----------------------------------------------------------------
            sFormTitle = MASTER_MARINE_TURTLE_CAPTIVE_FACILITY_QUARTERLY_REPORT_FOR_HATCHLINGS_PDF.Replace("MASTER - ", "").Replace(".master.pdf", "")

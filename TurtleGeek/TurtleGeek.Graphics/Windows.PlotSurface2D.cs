...
using TurtleGeek.Graphics;

namespace TurtleGeek.Graphics.Windows
{
	...
	/// </summary>
	/// <remarks>
	/// Unfortunately it's not possible to derive from both Control and TurtleGeek.Graphics.PlotSurface2D.
	/// </remarks>
	[ ToolboxBitmapAttribute(typeof(TurtleGeek.Graphics.Windows.PlotSurface2D),"app.ico") ]
	public class PlotSurface2D : System.Windows.Forms.Control, IPlotSurface2D, ISurface
	{
        ...
        private TurtleGeek.Graphics.PlotSurface2D ps_;
		...
		public PlotSurface2D()
		{
			...
			ps_ = new TurtleGeek.Graphics.PlotSurface2D();
		...
		public void DoPaint( PaintEventArgs pe, int width, int height )
		{
			...
			if ( g == null ) 
			{
				throw (new ApplicationException("Graphics context cannot be null."));
			}
			
			if ( ps_ == null )
			{
				throw (new ApplicationException("PlotSurface2D cannot be null."));
			}
			
			if ( border == Rectangle.Empty )
			{
				throw (new ApplicationException("Border context cannot be null."));
			}
		...
		public void Draw( System.Drawing.Graphics g, Rectangle bounds )
		{
		...
		/// </summary>
		private void drawDesignMode( System.Drawing.Graphics g, Rectangle bounds )
		{
		...
		public void Add( IDrawable p, TurtleGeek.Graphics.PlotSurface2D.XAxisPosition xp, TurtleGeek.Graphics.PlotSurface2D.YAxisPosition yp )
		{
			ps_.Add( p, xp, yp );
		}
		...
		/// <param name="yp">the y-axis to add the plot against.</param>
		/// <param name="zOrder">The z-ordering when drawing (objects with lower numbers are drawn first)</param>
		public void Add( IDrawable p, TurtleGeek.Graphics.PlotSurface2D.XAxisPosition xp,
			TurtleGeek.Graphics.PlotSurface2D.YAxisPosition yp, int zOrder )
		{
		...
		public TurtleGeek.Graphics.Legend Legend
		{
			get
			{
				return ps_.Legend;
        ...
        /// <param name="formIcon">Optional icon to display in the print preview window.</param>
        /// <param name="formCaption">Optional caption to display in the print preview window.</param>
        public void Print(bool preview, System.Drawing.Icon formIcon, string formCaption) 
		{
			PrintDocument printDocument = new PrintDocument();
			printDocument.PrintPage += new PrintPageEventHandler(Handler_PrintPage);
		...
		private void Handler_PrintPage(object sender, PrintPageEventArgs ev) 
		{
		...
		/// TurtleGeek.Graphics.Windows.PlotSurface2D.ContextMenu.
		/// </summary>
		[
		Browsable(false),
		Bindable(false)
		]
		public TurtleGeek.Graphics.Windows.PlotSurface2D.PlotContextMenu RightMenu
		{
			get
			{
				return rightMenu_;
		...
		private TurtleGeek.Graphics.Windows.PlotSurface2D.PlotContextMenu rightMenu_ = null;


		/// <summary>
		/// Gets an instance of a TurtleGeek.Graphics.Windows.PlotSurface2D.ContextMenu that
		...
		public static PlotContextMenu DefaultContextMenu
		{
			get
			{
				return new TurtleGeek.Graphics.Windows.PlotSurface2D.PlotContextMenu();
			}
		}
        ...
        public TurtleGeek.Graphics.PlotSurface2D Inner
        {
            get
            {
                return ps_;
        ...
        public abstract class Interactions
        {
            ...
            public class RubberBandSelection : Interaction
            {
                ...
                public override bool DoMouseUp(MouseEventArgs e, Control ctr)
                {
                    ...
                    TurtleGeek.Graphics.PlotSurface2D ps = ((Windows.PlotSurface2D)ctr).Inner;
            ...
            public class AxisDrag : Interaction
            {
                ...
                public override bool DoMouseDown(MouseEventArgs e, Control ctr)
                {
                    ...
                    if ((e.Button == MouseButtons.Left))
                    {
                        ...
                        {
                            if (o is TurtleGeek.Graphics.Axis)
                            {
                                doing_ = true;
                                axis_ = (Axis)o;
		...
		public class PlotContextMenu
		{
			...
			{
				plotSurface2D_.Print( false, null, String.Empty );
			}

			private void mnuPrintPreview_Click(object sender, System.EventArgs e) 
			{
                plotSurface2D_.Print( true, null, String.Empty );
			}

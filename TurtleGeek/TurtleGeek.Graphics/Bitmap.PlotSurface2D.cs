...
namespace TurtleGeek.Graphics
{
	...
	namespace Bitmap
	{
		...
		/// <summary>
		/// Wrapper around TurtleGeek.Graphics.PlotSurface2D that provides extra functionality
		...
		public class PlotSurface2D: IPlotSurface2D 
		{
			...
			public System.IO.MemoryStream ToStream( System.Drawing.Imaging.ImageFormat imageFormat ) 
			{
                ...
                ps_.Draw(System.Drawing.Graphics.FromImage(this.Bitmap), new System.Drawing.Rectangle(0, 0, b_.Width, b_.Height));
			...
			public void Refresh()
			{
				...
				{
                    System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(b_);
					g.FillRectangle( (new Pen( (Color)this.backColor_)).Brush,0,0,b_.Width,b_.Height );
				}
				ps_.Draw( System.Drawing.Graphics.FromImage(b_), new System.Drawing.Rectangle(0,0,b_.Width,b_.Height) );
			}

...
namespace TurtleGeek.Graphics
{
	...
	public class LogAxis : Axis
	{
		...
		public override object Clone()
		{
			...
			{
				throw new ApplicationException("Clone not defined in derived type of LogAxis.");
			}
			this.DoClone( this, a );
			return a;
		}
			...
			)
		{
			...
			{
                throw new ApplicationException("WorldMin or WorldMax value has not been set.");
			}
		...
		private double DetermineTickSpacing( )
		{
			...
			if ( !double.IsNaN( this.largeTickStep_) )
			{
				...
				{
					throw new ApplicationException( "Cannot have negative tick step; reverse WorldMin WorldMax instead." );
				}
		...
		private int DetermineNumberSmallTicks( double bigTickDist )
		{
			...
			{
				throw new ApplicationException("Major tick distance must be greater than or equal to 1.");
			}
		}
			...
			bool clip )
		{
			...
			if (coord < 0.0f)
			{
				throw new ApplicationException( "Cannot have negative values for data using Log Axis." );
			}
		...
		public override double WorldMin
		{
			...
			set
			{
				...
				{
					throw new ApplicationException("Cannot have negative values in Log Axis.");
				}
			}
		}

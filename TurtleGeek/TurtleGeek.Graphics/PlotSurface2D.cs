...
namespace TurtleGeek.Graphics
{
	...
	public class PlotSurface2D : IPlotSurface2D
	{
        ...
        private void UpdateAxes( bool recalculateAll )
		{
            ...
            {
                throw new ApplicationException("Plots and axis position arrays must have the same count.");
            }
		...
		private void DetermineAxesToDraw( out Axis xAxis1, out Axis xAxis2, out Axis yAxis1, out Axis yAxis2 )
		{
			...
			if (this.xAxis1_ == null)
			{
				if (this.xAxis2_ == null)
				{
					throw new ApplicationException( "X-Axis must be specified." );
				}
			...
			if (this.yAxis1_ == null)
			{
				if (this.yAxis2_ == null)
				{
					throw new ApplicationException( "Y-Axis must be specified." );
				}
		...
		/// control over where positions each axes, and the world-pixel ratio.
		/// </summary>

        ...
        private class TextDataAdapter
        {
            ...
            public string this[int i]
            {
                get
                {
                    ...
                    if (data_ is string)
                    {
                        if (dataSource_ == null)
                        {
                            throw new ApplicationException("DataSource cannot be null.");
                        }
                    ...
                    if (data_ is System.Collections.ArrayList)
                    {
                        ...
                        throw new ApplicationException("Data not in recognized format.");
                    }
                    ...
                    throw new ApplicationException("Text data not of recognized type.");
                }
            }
            ...
            public int Count
            {
                get
                {
                    ...
                    throw new ApplicationException("Text data not in correct format.");
                }
            }

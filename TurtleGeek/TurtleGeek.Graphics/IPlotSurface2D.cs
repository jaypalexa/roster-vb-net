...
namespace TurtleGeek.Graphics
{
	...
	public interface IPlotSurface2D
	{
		...
		/// <param name="zOrder">The z-ordering when drawing (objects with lower numbers are drawn first)</param>
		void Add( IDrawable p, TurtleGeek.Graphics.PlotSurface2D.XAxisPosition xp, TurtleGeek.Graphics.PlotSurface2D.YAxisPosition yp, int zOrder );
		...
		void Add(IDrawable p, TurtleGeek.Graphics.PlotSurface2D.XAxisPosition xax, TurtleGeek.Graphics.PlotSurface2D.YAxisPosition yax);
		...
		/// </summary>
		TurtleGeek.Graphics.Legend Legend { get; set; }

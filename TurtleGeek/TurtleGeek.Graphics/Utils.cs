...
namespace TurtleGeek.Graphics
{
	...
	internal class Utils
	{
		...
		public static double ToDouble( object o )
		{
			...
			throw new ApplicationException( "Expecting data type of DateTime or IConvertible." );
		}
		...
		public static System.Drawing.Bitmap TiledImage( System.Drawing.Bitmap image, Size size )
		{
			...
			for (int i=0; i<(size.Width / image.Width)+1; ++i)
			{
				...
				{
                    System.Drawing.Graphics.FromImage(final).DrawImage(image, i * image.Width, j * image.Height);
				}
			}

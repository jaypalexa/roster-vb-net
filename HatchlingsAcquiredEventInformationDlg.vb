...
Public Class HatchlingsAcquiredEventInformationDlg
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colTagHatchlingsAcquiredEventTagIDDataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
    Friend WithEvents colTagHatchlingsAcquiredEventIDDataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(HatchlingsAcquiredEventInformationDlg))
        ...
        '
        'HatchlingsAcquiredEventInformationDlg
        '
        ...
        Me.Name = "HatchlingsAcquiredEventInformationDlg"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Hatchlings Acquired Event"
...
#End Region
    ...
    Private moHatchlingsAcquiredEvent As HatchlingsAcquiredEvent

    Public Sub New(ByVal oHatchlingsAcquiredEvent As HatchlingsAcquiredEvent)
        ...
        moHatchlingsAcquiredEvent = oHatchlingsAcquiredEvent

    End Sub

    Private Sub frmHatchlingsAcquiredEventInformationDlg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            '*** ASSERTION ***
            If moHatchlingsAcquiredEvent Is Nothing Then
                Throw New ApplicationException("HatchlingsAcquiredEvent object must be set before opening this screen.")
            End If
            '*** ASSERTION ***
            ...
            '----------------------------------------------------------------
            moHatchlingsAcquiredEvent.BeginEdit()

            Me.cboSpeciesList.SelectedIndex = cboSpeciesList.FindString(moHatchlingsAcquiredEvent.SpeciesCode)

            Me.dtpEventDate.DateValue = moHatchlingsAcquiredEvent.EventDate

            If (moHatchlingsAcquiredEvent.EventCount = 0) Then
                Me.txtEventCount.Text = String.Empty
            Else
                Me.txtEventCount.Text = Convert.ToString(moHatchlingsAcquiredEvent.EventCount)
            End If

            Me.cboCountyList.SelectedIndex = cboCountyList.FindString(moHatchlingsAcquiredEvent.AcquiredFromCounty)
    ...
    Private Sub frmHatchlingsAcquiredEventInformationDlg_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Function DoCancelLogic() As Boolean
        ...
        Try
            ...
            '------------------------------------------------------------ 
            If moHatchlingsAcquiredEvent.IsDirty Then
            ...
            '------------------------------------------------------------ 
            moHatchlingsAcquiredEvent.CancelEdit()
    ...
    Private Function DoSaveLogic() As Boolean
        ...
        '------------------------------------------------------------ 
        Dim oTempHatchlingsAcquiredEvent As HatchlingsAcquiredEvent
        ...
        Try
            ...
            If moHatchlingsAcquiredEvent.IsDirty Then
                ...
                '------------------------------------------------------------ 
                If moHatchlingsAcquiredEvent.IsValid Then

                    '----------------------------------------------------------------
                    '-- commit edits in memory
                    '----------------------------------------------------------------
                    moHatchlingsAcquiredEvent.ApplyEdit()

                    '----------------------------------------------------------------
                    '-- clone and save the object (it is the CSLA way)
                    '----------------------------------------------------------------
                    oTempHatchlingsAcquiredEvent = moHatchlingsAcquiredEvent.Clone
                    moHatchlingsAcquiredEvent = oTempHatchlingsAcquiredEvent.Save
    ...
    Private Sub DisplayBrokenRules(Optional ByVal bShowMessageBox As Boolean = False)
        ...
        Try
            ...
            If (bShowMessageBox) Then
                MessageBox.Show(" *** The following data validation issue(s) must be resolved before this package can be saved: *** " & ControlChars.CrLf & ControlChars.CrLf & moHatchlingsAcquiredEvent.GetBrokenRulesString, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If

            For i = 0 To moHatchlingsAcquiredEvent.BrokenRulesCollection.Count() - 1
                Select Case moHatchlingsAcquiredEvent.BrokenRulesCollection(i).Property
                    Case "EventCount"
                        erpErrorProvider.SetError(Me.txtEventCount, moHatchlingsAcquiredEvent.BrokenRulesCollection(i).Description)
                End Select
            Next
    ...
    Private Sub CopyFormValuesToBusinessObject()
        ...
        If cboSpeciesList.SelectedIndex > -1 Then
            moHatchlingsAcquiredEvent.SpeciesCode = CType(Me.cboSpeciesList.SelectedItem, KeyValueInfo).Key
        End If

        moHatchlingsAcquiredEvent.EventDate = Me.dtpEventDate.DateValue
        moHatchlingsAcquiredEvent.EventCount = Convert.ToInt32(Val(Me.txtEventCount.Text.Trim))
        moHatchlingsAcquiredEvent.AcquiredFromCounty = Me.cboCountyList.Text.Trim

    End Sub

    Private Sub btnHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        Help.ShowHelp(Me, gsHelpFileName, "HatchlingsAcquiredEventScreen.htm")
    End Sub

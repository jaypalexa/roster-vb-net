...
<Serializable()> _
Public Class HatchlingsEventListItem
    Inherits BusinessBase(Of HatchlingsEventListItem)
    ...
    Friend Sub New(ByVal sEventID As String, ByVal sSpeciesDescription As String, ByVal dtEventDate As Date, ByVal sEventType As String, ByVal iEventCount As Integer, ByVal sCountyName As String)
        msEventID = sEventID

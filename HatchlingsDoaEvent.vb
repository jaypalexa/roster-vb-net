...
<Serializable()> _
Public Class HatchlingsDoaEvent
    Inherits BusinessBase(Of HatchlingsDoaEvent)

#Region " Business Methods "

    Private msHatchlingsDoaEventID As String = String.Empty
    ...
    Public ReadOnly Property HatchlingsDoaEventID() As String
        Get
            Return msHatchlingsDoaEventID
        End Get
    End Property
...
#Region " Factory Methods "
    ...
    Public Shared Function NewHatchlingsDoaEvent() As HatchlingsDoaEvent

        Dim oHatchlingsDoaEvent As HatchlingsDoaEvent
        oHatchlingsDoaEvent = DataPortal.Create(Of HatchlingsDoaEvent)()
        oHatchlingsDoaEvent.MarkClean()
        Return oHatchlingsDoaEvent

        'Return DataPortal.Create(Of HatchlingsDoaEvent)()

    End Function

    Public Shared Function GetHatchlingsDoaEvent(ByVal sHatchlingsDoaEventId As String) As HatchlingsDoaEvent

        Return DataPortal.Fetch(Of HatchlingsDoaEvent)(New Criteria(sHatchlingsDoaEventId))

    End Function

    Public Shared Sub DeleteHatchlingsDoaEvent(ByVal sHatchlingsDoaEventId As String)

        DataPortal.Delete(New Criteria(sHatchlingsDoaEventId))

    End Sub

    Public Overrides Function Save() As HatchlingsDoaEvent
...
#Region " Data Access "
    ...
    Private Class Criteria
        ...
        Private msHatchlingsDoaEventId As String
        Public ReadOnly Property HatchlingsDoaEventId() As String
            Get
                Return msHatchlingsDoaEventId
            End Get
        ...
        Public Sub New(ByVal sHatchlingsDoaEventId As String)
            msHatchlingsDoaEventId = sHatchlingsDoaEventId
        End Sub
    End Class
    ...
    Protected Overrides Sub DataPortal_Create()
        ...
        msHatchlingsDoaEventID = Guid.NewGuid.ToString.ToUpper
        msSpeciesCode = "XX"
    ...
    Private Overloads Sub DataPortal_Fetch(ByVal oCriteria As Criteria)
        ...
        Using oAdoHelper As AdoHelper = AdoHelper.CreateHelper()
            ...
            s = "SELECT * FROM hatchlings_doa_event "
            s &= "WHERE " & oAdoHelper.UpperFunction & "(hatchlings_doa_event_id) = " & oAdoHelper.UpperFunction & "(@hatchlings_doa_event_id) "

            Using dr As SafeDataReader = oAdoHelper.ExecuteReader(CommandType.Text, s, oAdoHelper.GetParameter("@hatchlings_doa_event_id", oCriteria.HatchlingsDoaEventId))

                If dr.Read() Then

                    With dr
                        msHatchlingsDoaEventID = .GetString("hatchlings_doa_event_id").Trim.ToUpper
            ...
            Using cn As IDbConnection = oAdoHelper.GetConnection()
                ...
                Using ts As TransactionScope = New TransactionScope()
                    ...
                    Using cm As IDbCommand = cn.CreateCommand()
                        ...
                        s &= "INSERT INTO hatchlings_doa_event ("
                        s &= "species_code, event_date, event_count, doa_from_county, "
                        s &= "hatchlings_doa_event_id "
                        s &= ") VALUES ("
                        s &= "@species_code, @event_date, @event_count, @doa_from_county, "
                        s &= "@hatchlings_doa_event_id "
                        s &= ")"
                ...
                Using ts As TransactionScope = New TransactionScope()
                    ...
                    If MyBase.IsDirty Then
                        ...
                        Using cm As IDbCommand = cn.CreateCommand()
                            ...
                            s &= "UPDATE hatchlings_doa_event SET "
    ...
    Private Sub DoInsertUpdate(ByVal cm As IDbCommand)
        ...
        Using oAdoHelper As AdoHelper = AdoHelper.CreateHelper()
            With cm
                ...
                .Parameters.Add(oAdoHelper.GetParameter("@hatchlings_doa_event_id", msHatchlingsDoaEventID))
    ...
    Protected Overrides Sub DataPortal_DeleteSelf()
        ...
        DataPortal_Delete(New Criteria(msHatchlingsDoaEventID))
            ...
            Using cn As IDbConnection = oAdoHelper.GetConnection()
                ...
                Using ts As TransactionScope = New TransactionScope()
                    ...
                    Using cm As IDbCommand = cn.CreateCommand()
                        ...
                        cm.CommandText = "DELETE FROM hatchlings_doa_event WHERE " & oAdoHelper.UpperFunction & "(hatchlings_doa_event_id) = " & oAdoHelper.UpperFunction & "(@hatchlings_doa_event_id)"
                        cm.Parameters.Add(oAdoHelper.GetParameter("@hatchlings_doa_event_id", oCriteria.HatchlingsDoaEventId.ToUpper))
                        oAdoHelper.ExecuteNonQuery(cm)
...
#Region " Exists "
    ...
    Public Shared Function Exists(ByVal sHatchlingsDoaEventId As String) As Boolean

        Dim oExistsCommand As ExistsCommand

        oExistsCommand = DataPortal.Execute(Of ExistsCommand)(New ExistsCommand(sHatchlingsDoaEventId))
        ...
        Protected Overrides Sub DataPortal_Execute()
            ...
            Using oAdoHelper As AdoHelper = AdoHelper.CreateHelper()
                Using cn As IDbConnection = oAdoHelper.GetConnection()
                    ...
                    Using cm As IDbCommand = cn.CreateCommand()
                        cm.CommandType = CommandType.Text
                        cm.CommandText = "SELECT hatchlings_doa_event_id FROM hatchlings_doa_event WHERE " & oAdoHelper.UpperFunction & "(hatchlings_doa_event_id) = " & oAdoHelper.UpperFunction & "(@hatchlings_doa_event_id)"
                        cm.Parameters.Add(oAdoHelper.GetParameter("@hatchlings_doa_event_id", msHatchlingsDoaEventId))

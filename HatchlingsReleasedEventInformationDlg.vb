...
Public Class HatchlingsReleasedEventInformationDlg
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents colTagHatchlingsReleasedEventTagIDDataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
    Friend WithEvents colTagHatchlingsReleasedEventIDDataGridViewTextBoxColumn As System.Windows.Forms.DataGridViewTextBoxColumn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(HatchlingsReleasedEventInformationDlg))
        ...
        '
        'HatchlingsReleasedEventInformationDlg
        '
        ...
        Me.Name = "HatchlingsReleasedEventInformationDlg"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Hatchlings Released Event"
...
#End Region
    ...
    Private moHatchlingsReleasedEvent As HatchlingsReleasedEvent

    Public Sub New(ByVal oHatchlingsReleasedEvent As HatchlingsReleasedEvent)
        ...
        moHatchlingsReleasedEvent = oHatchlingsReleasedEvent

    End Sub

    Private Sub frmHatchlingsReleasedEventInformationDlg_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            '*** ASSERTION ***
            If moHatchlingsReleasedEvent Is Nothing Then
                Throw New ApplicationException("HatchlingsReleasedEvent object must be set before opening this screen.")
            End If
            '*** ASSERTION ***
            ...
            '----------------------------------------------------------------
            moHatchlingsReleasedEvent.BeginEdit()

            Me.cboSpeciesList.SelectedIndex = cboSpeciesList.FindString(moHatchlingsReleasedEvent.SpeciesCode)

            Me.dtpEventDate.DateValue = moHatchlingsReleasedEvent.EventDate

            If (moHatchlingsReleasedEvent.BeachEventCount = 0) Then
                Me.txtBeachEventCount.Text = String.Empty
            Else
                Me.txtBeachEventCount.Text = Convert.ToString(moHatchlingsReleasedEvent.BeachEventCount)
            End If

            If (moHatchlingsReleasedEvent.OffshoreEventCount = 0) Then
                Me.txtOffshoreEventCount.Text = String.Empty
            Else
                Me.txtOffshoreEventCount.Text = Convert.ToString(moHatchlingsReleasedEvent.OffshoreEventCount)
            End If
    ...
    Private Sub frmHatchlingsReleasedEventInformationDlg_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Function DoCancelLogic() As Boolean
        ...
        Try
            ...
            '------------------------------------------------------------ 
            If moHatchlingsReleasedEvent.IsDirty Then
            ...
            '------------------------------------------------------------ 
            moHatchlingsReleasedEvent.CancelEdit()
    ...
    Private Function DoSaveLogic() As Boolean
        ...
        '------------------------------------------------------------ 
        Dim oTempHatchlingsReleasedEvent As HatchlingsReleasedEvent
        ...
        Try
            ...
            If moHatchlingsReleasedEvent.IsDirty Then
                ...
                '------------------------------------------------------------ 
                If moHatchlingsReleasedEvent.IsValid Then

                    '----------------------------------------------------------------
                    '-- commit edits in memory
                    '----------------------------------------------------------------
                    moHatchlingsReleasedEvent.ApplyEdit()

                    '----------------------------------------------------------------
                    '-- clone and save the object (it is the CSLA way)
                    '----------------------------------------------------------------
                    oTempHatchlingsReleasedEvent = moHatchlingsReleasedEvent.Clone
                    moHatchlingsReleasedEvent = oTempHatchlingsReleasedEvent.Save
    ...
    Private Sub DisplayBrokenRules(Optional ByVal bShowMessageBox As Boolean = False)
        ...
        Try
            ...
            If (bShowMessageBox) Then
                MessageBox.Show(" *** The following data validation issue(s) must be resolved before this package can be saved: *** " & ControlChars.CrLf & ControlChars.CrLf & moHatchlingsReleasedEvent.GetBrokenRulesString, Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If

            For i = 0 To moHatchlingsReleasedEvent.BrokenRulesCollection.Count() - 1
                Select Case moHatchlingsReleasedEvent.BrokenRulesCollection(i).Property
                    Case "BeachEventCount"
                        erpErrorProvider.SetError(Me.txtBeachEventCount, moHatchlingsReleasedEvent.BrokenRulesCollection(i).Description)
                    Case "OffshoreEventCount"
                        erpErrorProvider.SetError(Me.txtOffshoreEventCount, moHatchlingsReleasedEvent.BrokenRulesCollection(i).Description)
                End Select
            Next
    ...
    Private Sub CopyFormValuesToBusinessObject()
        ...
        If cboSpeciesList.SelectedIndex > -1 Then
            moHatchlingsReleasedEvent.SpeciesCode = CType(Me.cboSpeciesList.SelectedItem, KeyValueInfo).Key
        End If

        moHatchlingsReleasedEvent.EventDate = Me.dtpEventDate.DateValue
        moHatchlingsReleasedEvent.BeachEventCount = Convert.ToInt32(Val(Me.txtBeachEventCount.Text.Trim))
        moHatchlingsReleasedEvent.OffshoreEventCount = Convert.ToInt32(Val(Me.txtOffshoreEventCount.Text.Trim))

    End Sub

    Private Sub btnHelp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHelp.Click
        Help.ShowHelp(Me, gsHelpFileName, "HatchlingsReleasedEventScreen.htm")
    End Sub
